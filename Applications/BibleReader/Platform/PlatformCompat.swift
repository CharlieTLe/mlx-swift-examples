...
/// `ChapterReaderView`'s pointer gestures), not scattered through the view bodies.
///
...
/// long-press-then-drag in `ChapterReaderView` is the touch affordance that replaces
/// shift-click anyway.
