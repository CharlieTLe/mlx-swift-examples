...
/// (`ContentView`'s container and `DocumentReaderView`'s pointer gestures). It lives here
...
final class DictionaryAnchor {
    ...
    ///
    /// Named rather than `.local`, because the point is resolved inside a `DocumentRowView` and
